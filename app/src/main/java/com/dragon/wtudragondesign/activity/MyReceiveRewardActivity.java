...
import com.dragon.wtudragondesign.adapter.MyReceiveAdapter;
...
public class MyReceiveRewardActivity extends BaseActivity {
    ...
    //快递信息的适配器
    private MyReceiveAdapter courierAdapter;
    ...
    @Override
    public void init() {
        mRvMyReward = fv(R.id.rv_my_receive);
    ...
    private void getMyPush() {
        ...
        Call<ResultEntity> call = api.MyReceive(userId);
            ...
            public void onResponse(Call<ResultEntity> call,
                ...
                if (res == 1) {// 请求成功
                    ...
                    if (mCourierList.size() > 0) {
                        ...
                        courierAdapter = new MyReceiveAdapter(mCourierList);
