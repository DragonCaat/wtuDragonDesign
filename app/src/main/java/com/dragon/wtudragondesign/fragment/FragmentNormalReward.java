...
public class FragmentNormalReward extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_normal_reward, container, false);
        init();
        initData();
        return view;
    }
    ...
    private void init(){
        ...
        mRvReward.setLayoutManager(manager);
    ...
    private void getNormalPush() {
        ...
        Call<ResultEntity> call = api.publish(params);
