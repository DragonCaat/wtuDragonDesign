...
public class PreferencesUtils {
	//key
	public static String PREFERENCE_NAME = "Dragon_wtu_data";
	...
	/**
	 * 对象本地化 把对象的各个字段写入SharedPreferences
	 * 
	 * @param context
	 * @param model
	 * @param shareKey
	 ...
	 */
	//ImUtils.setLocalModel(LoginActivity.this, result, AppConstant.APP_USER);
	public static void setLocalModel(Context context, Object model,
			String shareKey) {
